...
def main():
    ...
    parser.add_argument(
        "--input",
        default=["/content/drive/MyDrive/ML/dataset/fs_static/images/*.*"],
        nargs="+",
        help="A list of space separated input images; "
        "or a single glob pattern such as 'directory/*.jpg'",
    )  
    parser.add_argument('--config_path', default="drive/MyDrive/ML/eomt/configs/dinov2/cityscapes/semantic/eomt_base_640.yaml", help="Path to yaml config file")
